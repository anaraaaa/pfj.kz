      ...
      <div class="container">
        <div class="row">
          <section class="content__left col-md-8">
            <div class="block">
              <h3>Запрос не найден!</h3>
              <div class="block__content">
                <div class="full-text">
                  Запрашиваемый Вами запрос не существует!
                </div>
          ...
          <div class="block__content">
            <div class="articles articles__vertical">
                  <?php
                      ...
                      <div class="article__image" style="background-image: url(https://www.gravatar.com/avatar/<?php echo md5 ($comment['email']); ?>?$=125);"></div>
                      <div class="article__info">
                        <a href="/article.php?id=<?php echo $comment['articles_id']; ?>"><?php echo $comment['author']; 
                        ?></a>
            ...
            <div id="comment-add-form" class="block">
              ...
              <form class="form" method="POST" action="/article.php?id=<?php echo $art['id']; ?>#comment-add-form">
                ...
                <div class="form__group">
                 <div class="row">
                  <div class="col-md-4">
                    <input type="text" name="author" class="form__control"
                    placeholder="Имя" value="<?php echo $_POST['author']; ?>">
                  </div>
                  <div class="col-md-4">
